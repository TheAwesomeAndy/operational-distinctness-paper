...
\node[perc] (perc) at (7.4,3.4)  {Neural decoder\\[1pt]{\scriptsize ARSPI-Net substrate $\rightarrow$ belief $b(s)$}\\[-1pt]{\scriptsize Dirichlet update\ $\boldsymbol{\alpha}\!\leftarrow\!\boldsymbol{\alpha}\!+\!\mathbf{p}_{\theta}(x_t)$}};
