...
\node[env, text width=41mm]  (env)  at (0,3.4)    {Recorded ERP observation bank\,/\,simulated affective-state process\\[2pt]{\scriptsize held-out subject-condition observation}\\[-1pt]{\scriptsize simulated affective-state transition}};
